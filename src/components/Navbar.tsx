  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled ? "bg-[#004488] shadow-lg py-2" : "bg-[#004488]/95 backdrop-blur-sm py-3"
      }`}
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex-shrink-0">
            <Image src="/logo.png" alt="Azultech Engenharia" width={160} height={48} className="h-12 w-auto" />
          </Link>
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            {/* Services Dropdown - CSS group hover ensures it stays open seamlessly */}
            <div className="relative group py-2">
              ...
              <div className="absolute top-full left-0 w-64 bg-white rounded-lg shadow-xl border border-gray-100 py-2 hidden group-hover:block transition-all z-50">
                {services.map((s) => (
                  <Link
                    key={s.href}
                    href={s.href}
