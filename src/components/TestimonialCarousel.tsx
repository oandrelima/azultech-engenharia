      ...
      >
        {testimonials.map((t) => {
          ...
          return (
            ...
            >
              <div className="bg-[#ffffff] rounded-2xl p-6 sm:p-7 shadow-md hover:shadow-xl border border-gray-100 hover:border-orange-300 transition-all duration-300 h-full flex flex-col justify-between group">
                <div>
