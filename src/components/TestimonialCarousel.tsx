    ...
    <div className="relative">
      ...
      <div className="flex items-center justify-end gap-3 mb-6">
        <button
          ...
          className="w-12 h-12 rounded-full border-2 border-[#004488] text-[#004488] hover:bg-[#004488] hover:text-white disabled:opacity-30 disabled:border-gray-200 disabled:text-gray-300 disabled:hover:bg-transparent flex items-center justify-center transition-all duration-300 shadow-sm active:scale-95"
        >
        ...
        <button
          ...
          className="w-12 h-12 rounded-full bg-orange-500 hover:bg-orange-600 text-white disabled:opacity-30 disabled:bg-gray-200 disabled:text-gray-400 flex items-center justify-center transition-all duration-300 shadow-md hover:shadow-orange-200 active:scale-95"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        {testimonials.map((t) => {
          ...
          return (
            ...
            >
              <div className="bg-white rounded-2xl p-7 shadow-md hover:shadow-xl border border-gray-100 hover:border-orange-300 transition-all duration-300 h-full flex flex-col justify-between group">
                <div>
