    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <h1 className="text-3xl font-black mb-4 text-gray-800">Serviço não encontrado</h1>
          ...
          <div className="grid lg:grid-cols-3 gap-10 items-start">
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              {service.benefits.length > 0 && (
                <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100">
                  <h3 className="font-head text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                ...
                <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {service.targetNeighborhoods.map((neighborhood) => (
                      <span
                        key={neighborhood}
                        className="bg-blue-50 border border-blue-100 text-[#004488] text-xs font-semibold px-3 py-1.5 rounded-lg"
                      >
                        {neighborhood}
                      </span>
                    ))}
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    {service.relatedServices.map((s) => (
                      <Link
                        ...
                        className="block bg-gray-50 hover:bg-orange-50 border border-gray-100 hover:border-orange-200 rounded-xl p-4 transition-all group"
                      >
                        <h4 className="font-bold text-gray-900 text-sm group-hover:text-orange-600 mb-1 transition-colors">
                          {s.title}
                        </h4>
            ...
            <div className="lg:col-span-1 sticky top-24">
              ...
              <div className="bg-white rounded-2xl p-5 shadow-md border border-gray-100 text-center">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold px-4 py-3 rounded-xl w-full transition-colors text-sm"
                >
